...
hgg_only_meta <- metadata %>%
  ...
  filter(pathology_diagnosis %in% path_dx_list$exact_path_dx |
         ...
         pathology_free_text_diagnosis %in% path_dx_list$IHG_path_free_path_dx |
           # include HGG high-conf methyl classifications from DKFZ and NIH
  ...
  # remove LGG PXAs
  filter(!(pathology_diagnosis == "Low-grade glioma/astrocytoma (WHO grade I/II)" & NIH_v2_methylation_Class == "PXA"))
