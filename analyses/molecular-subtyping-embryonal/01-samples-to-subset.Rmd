...
rare_fusion_summary_df <- read_tsv(file.path(root_dir,
                                             "analyses", 
                                             "fusion-summary",
                                             "results",
...
emb_methyl_subtyped <- histologies_df %>% 
  ...
  dplyr::mutate(molecular_subtype_methyl = 
                  case_when(dkfz_v12_methylation_subclass == "CNS_NB_FOXR2" ~ "Rare CNS, FOXR2 NBL",
                            dkfz_v12_methylation_subclass == "ETMR_C19MC" ~ "ETMR, C19MC-altered",
                            dkfz_v12_methylation_subclass == "CNS_BCOR_ITD" ~ "Rare CNS, BCOR ITD",
                            dkfz_v12_methylation_subclass == "NET_CXXC5" ~ "Rare CNS, MN1::CXXC5",
                            dkfz_v12_methylation_subclass == "ABM_MN1" ~ "Rare CNS, MN1::BEND2")) %>% 
