...
hist <- read_tsv(file.path(dataDir, "/testing/histologies-base.tsv"))
...
putativeOncogenicDF <- 
  read_tsv(file.path(dataDir, "/testing/fusion-putative-oncogenic.tsv"))
}
...
```{r}
# read in DGD data 
dgd_fusion <- readr::read_tsv(file.path(dataDir, "/testing/fusion-dgd.tsv.gz"))
