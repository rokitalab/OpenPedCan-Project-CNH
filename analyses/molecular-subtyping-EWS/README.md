...
`01-run-subtyping-ewings.Rmd` identifies sample_id for RNA-Seq samples with hallmark _EWSR1_ fusions for only PBTA tumors, matches sample_id with WGS sample and adds molecular_subtype as "Rare CNS, EWS" (Ewing Sarcoma).
